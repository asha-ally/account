...
class Account:
	...
	def deposit(self,amount):
		...
		deposit = "Dear {} {} deposit of ksh {} was successful ".format(self.first_name,self.last_name,amount,self.balance)
		return deposit
	...
	def withdraw(self,amount):
		...
		if amount>self.balance:
			...
			self.balance = self.balance - amount
			message = "Dear {} {} withdrawal of ksh {} was successful ".format(self.first_name,self.last_name,amount,self.balance)
		return message
	...
	def pay_loan(self,amount):
		if self.loan==0:
			...
			print("Hello {} you have paid in excess of what is required.Your new balance is {}".format(self.first_name,self.balance))